    ...
    @if ($label)
        ...
        >
            @if ($icon)
                <x-filament::icon
                    :icon="$icon"
                    class="fi-sidebar-group-icon h-6 w-6 text-violet-400 dark:text-violet-500"
                />
            @endif

            <span
                class="fi-sidebar-group-label flex-1 text-sm font-medium leading-6 text-black-500 dark:text-black-400"
            >
                {{ $label }}
            </span>
            ...
            <x-slot name="trigger">
                ...
                >
                    <x-filament::icon
                        ...
                        @class([
                            'h-6 w-6',
                            'text-orange-400 dark:text-orange-500' => ! $active,
