...
<x-filament-panels::page><div x-data="{ selectedOption: @entangle('selectedOption') }"
    ...
    <style>
        ...
        /* Se houver svgs com classes utilitárias tailwind (w-5 h-5) dentro desses botões,
           sobrescrevemos para garantir o tamanho correto. */
                                ...
                                @if (isset($currentStep['sim']) || isset($currentStep['nao']))
                                    ...
                                    <div class="flex flex-wrap gap-3 w-full items-center justify-start"> 
                                        ...
                                        @if ($isModeloPessoaStep)
                                            ...
                                            @if (isset($currentStep['nao']))
                                                <button type="button"
                                                    ...
                                                    <svg class="icon-continuar w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
                                        ...
                                        @else
                                            ...
                                            @if(count($history) > 0)
                                                <button type="button" wire:click="goBack" class="base-btn btn-ghost btn-same-size btn-voltar" aria-label="Voltar"> {{-- Botão Voltar ajustado --}}
                                                    <svg class="icon-voltar w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 17l-5-5m0 0l5-5m-5 5h12" />
                                                    </svg>
                                                    <span>Voltar</span>
