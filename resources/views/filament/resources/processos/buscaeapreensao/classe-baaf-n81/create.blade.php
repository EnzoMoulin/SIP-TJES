<x-filament-panels::page>
    ...
    <style>
        ...
        .summary-item .a { flex: 0 0 auto; align-self: center; font-size: .82rem; font-weight: 700; padding: .28rem .5rem; border-radius: 999px; text-transform: uppercase; }
        ...
        @media (max-width: 920px) {
            .summary-wrapper { left: 1rem; right: 1rem; width: auto; max-width: calc(100% - 2rem); bottom: 1rem; }
            .summary-panel { padding: .75rem; }
            .summary-list { max-height: 34vh; }
        }

        @media (max-width: 480px) {
            .summary-wrapper { bottom: .75rem; left: .5rem; right: .5rem; }
            .summary-panel { padding: .6rem; border-radius: .75rem; }
            .summary-title h3 { font-size: 1rem; }
            .summary-item .q { font-size: .9rem; }
        }
    </style>
